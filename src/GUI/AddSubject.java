        ...
        try
        {
            if( !txtSubjectName.getText().trim().isEmpty() )
            {
                if(cmbLecturer.getSelectedItem()!=null)
                {
                    ...
                    pstmt.executeUpdate();
                    JOptionPane.showMessageDialog(rootPane, "Subject Added", "SUCCESS", JOptionPane.PLAIN_MESSAGE);
                }
                else
                    JOptionPane.showMessageDialog(rootPane, "Please Add A Lecturer First", "FAILED", JOptionPane.WARNING_MESSAGE);
            }
            else
            {
               JOptionPane.showMessageDialog(rootPane, "Please Provide Subject Name", "FAILED", JOptionPane.WARNING_MESSAGE);
